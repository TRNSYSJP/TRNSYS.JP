...
FILE_PATH = r'.\Project\ENERGY_TOT.BAL'  # File path to read
OUTPUT_PATH = 'balance5_energy_tot.html'  # html file path to save
FIGURE_TITLE = 'Balance 5 - Sensible energy balance - Sum of all zones'# Figure title, e.g. 'Energy balance for surface - surface no.0001'
...
if __name__ == '__main__':
    ...
    # Columns to plot
    balance_cols =  ['DQAIRdt_tot','QHEAT_tot','QCOOL_tot','QINF_tot','QVENT_tot','QCOUP_tot',
                     'QTRANS_tot','QGINT_tot','QWGAIN_tot','QSOL_tot','QSOLAIR_tot']
    # Columns with positive values
    positive_value_cols =['TIME', 'REL_BAL_ENERGY','BAL_ENERG_tot','QHEAT_tot','QINF_tot','QVENT_tot','QCOUP_tot',
                     'QTRANS_tot','QGINT_tot','QWGAIN_tot','QSOL_tot','QSOLAIR_tot']
