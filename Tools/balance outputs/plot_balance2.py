...
FILE_PATH = r'.\Project\SOLAR_TOT.BAL'  # File path to read
OUTPUT_PATH = 'balance2_solar_tot.html'  # html file path to save
FIGURE_TITLE = 'Balance 2 - Solar balance for Sum of all zones' # Figure title, e.g. 'Energy balance for surface - surface no.0001'
...
if __name__ == '__main__':
    ...
    # Columns to plot
    balance_cols = ['QSOLTOT_TOT','QSOLADJ_TOT','QSOLBLK_TOT','QSOLLOST_TOT','QSOLGAIN_TOT']
    # Columns with positive values
    positive_value_cols = ['TIME', 'REL_BALQSOL_TOT', 'BAL_QSOL_TOT', 'QSOLTOT_TOT','QSOLADJ_TOT']
