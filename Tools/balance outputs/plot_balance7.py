...
FILE_PATH = r'.\Project\MOISTURE_Zone.BAL'  # File path to read
OUTPUT_PATH = 'balance7_moisture_zone - Zone no. {selected_group_name}.html'  # html file path to save
FIGURE_TITLE = 'Balance 7 - Moisture balance for zones - Zone no. {selected_group_name}' # Figure title, e.g. 'Energy balance for surface - surface no.0001'
Y_AXIS_RANGE = [-15, 15] # Y-axis range, e.g. [-30000, 30000]
...
if __name__ == '__main__':
    ...
    # Columns to plot
    balance_cols =  ['B7_mdwAIR','B7_mdwBUF','B7_mwINF','B7_mwVENT','B7_mwCOUP','B7_mwIGAIN','B7_mwHUM','B7_mwDHUM']
    # Columns with positive values
    positive_value_cols =['TIME', 'REL_B7_mwBAL', 'B7_mwBAL','B7_mdwAIR', 'B7_mdwBUF','B7_mwDHUM']
